            ...
            File(projectDir, "${modId}.version")
                .writeText(
                    ...
                    # THIS FILE IS GENERATED BY build.gradle.kts.
                    {
                        ...
                        "directDownloadURL": "https://github.com/DesperatePeter/mnemonic-sensors/releases/download/v${version._1}.${version._2}.${version._3}/MnemonicUtils-v${version._1}.${version._2}.${version._3}.zip",
